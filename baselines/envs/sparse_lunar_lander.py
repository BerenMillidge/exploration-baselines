...
#Sparse lunar lander. Rewawrd of 1 if and only if landed successfully on the pad.
...
class SparseLunarLander(gym.Env, EzPickle):
    ...
    def __init__(self,fuel_costs=False):
...
class SparseLunarLanderContinuous(SparseLunarLander):
    continuous = True
